...
public class RestPathAnnotationHandler {
    ...
    static final DotName PATH_TEMPLATE_ANNOTATION = DotName.createSimple("io.quarkus.micrometer.runtime.binder.QuarkusTemplateUriPath");

    static AnnotationsTransformerBuildItem transformAnnotations(final IndexView index, Optional<ResteasyJaxrsConfigBuildItem> resteasyJaxrsConfig) {
